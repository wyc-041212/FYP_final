...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Sweep thresholds on the within-protocol CDF cache.")
...
def main() -> None:
    ...
    payload = {
        "mode": "within_cdf_threshold_sweep",
        "config": {
    ...
    for threshold in args.thresholds:
        threshold = float(threshold)
        fake_summary = summarize_fake_only(fake_rows, threshold, list(runtime.hybrid_labels))
